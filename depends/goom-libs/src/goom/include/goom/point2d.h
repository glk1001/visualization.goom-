...
[[nodiscard]] constexpr auto ToPoint2dFlt(const Vec2dFlt& point) noexcept -> Point2dFlt;
...
constexpr auto ToPoint2dFlt(const Vec2dFlt& vec2dFlt) noexcept -> Point2dFlt
{
  return {vec2dFlt.x, vec2dFlt.y};
}
