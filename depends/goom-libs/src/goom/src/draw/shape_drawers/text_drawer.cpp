...
private:
  ...
  static constexpr auto DEFAULT_FONT_SIZE      = 100;
  int32_t m_fontSize                           = DEFAULT_FONT_SIZE;
  static constexpr auto DEFAULT_HORIZONTAL_RES = 90U;
  uint32_t m_horizontalResolution              = DEFAULT_HORIZONTAL_RES;
  static constexpr auto DEFAULT_VERTICAL_RES   = 90U;
  uint32_t m_verticalResolution                = DEFAULT_VERTICAL_RES;
  static constexpr auto DEFAULT_OUTLINE_WIDTH  = 3.0F;
