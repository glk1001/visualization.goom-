...
// clang-format off
constexpr float CHANGE_FILTER_MODE_PROB                       = 0.05F;
constexpr float CHANGE_STATE_PROB                             = 0.50F;
constexpr float CHANGE_TO_MEGA_LENT_MODE_PROB                 = 1.0F / 700.F;
constexpr float CHANGE_LINE_CIRCLE_AMPLITUDE_PROB             = 0.33F;
constexpr float CHANGE_LINE_CIRCLE_PARAMS_PROB                = 0.50F;
constexpr float CHANGE_H_LINE_PARAMS_PROB                     = 0.75F;
constexpr float CHANGE_V_LINE_PARAMS_PROB                     = 0.66F;
constexpr float REDUCE_LINE_MODE_PROB                         = 0.20F;
constexpr float UPDATE_LINE_MODE_PROB                         = 0.25F;
constexpr float CHANGE_LINE_TO_BLACK_PROB                     = 0.50F;
constexpr float CHANGE_GOOM_LINE_PROB                         = 0.33F;
constexpr float FILTER_REVERSE_ON_PROB                        = 0.10F;
constexpr float FILTER_REVERSE_OFF_AND_STOP_SPEED_PROB        = 0.20F;
...
constexpr float TURN_OFF_NOISE_PROB                           = 0.60F;
...
constexpr float V_LINE_LINE_TYPE_WEIGHT =  2.0F;
// clang-format on
