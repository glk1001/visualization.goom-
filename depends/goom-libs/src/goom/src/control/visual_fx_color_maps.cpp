...
auto VisualFxColorMaps::GetColorMatchedSet1() -> ColorMatchedSet
{
  ...
  matchedSet.at(ToUType(GoomEffect::SHAPES1)) = GetMostlySequentialSlimMaps;
...
auto VisualFxColorMaps::GetColorMatchedSet2() -> ColorMatchedSet
{
  ...
  matchedSet.at(ToUType(GoomEffect::SHAPES1)) = GetHeatStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES2)) = GetHeatStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES3)) = GetHeatStandardMaps;
...
auto VisualFxColorMaps::GetColorMatchedSet3() -> ColorMatchedSet
{
  ...
  matchedSet.at(ToUType(GoomEffect::SHAPES0)) = GetSlightlyDivergingSlimMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES1)) = GetSlightlyDivergingSlimMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES2)) = GetSlightlyDivergingSlimMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES3)) = GetSlightlyDivergingSlimMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES4)) = GetSlightlyDivergingSlimMaps;
...
auto VisualFxColorMaps::GetColorMatchedSet4() -> ColorMatchedSet
{
  ...
  matchedSet.at(ToUType(GoomEffect::SHAPES0)) = GetBlueStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES1)) = GetBlueStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES2)) = GetBlueStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES3)) = GetBlueStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES4)) = GetBlueStandardMaps;
...
auto VisualFxColorMaps::GetColorMatchedSet5() -> ColorMatchedSet
{
  ...
  matchedSet.at(ToUType(GoomEffect::SHAPES2)) = GetPastelStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES3)) = GetPastelStandardMaps;
  matchedSet.at(ToUType(GoomEffect::SHAPES4)) = GetPastelStandardMaps;
