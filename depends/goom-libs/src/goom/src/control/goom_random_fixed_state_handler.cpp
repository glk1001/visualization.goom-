module Goom.Control.GoomRandomFixedStateHandler;
...
GoomRandomFixedStateHandler::GoomRandomFixedStateHandler(const IGoomRand& goomRand)
  : m_weightedStates{
        goomRand,
        {
...
auto GoomRandomFixedStateHandler::ChangeToNextState() -> void
{
