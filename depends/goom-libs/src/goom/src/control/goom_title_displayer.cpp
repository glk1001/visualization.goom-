    ...
    -> Pixel
{
  ...
  return IColorMap::GetColorMix(fontColor, charColor, fontTs.fontCharColorMixT);
}
                                                ...
                                                const int32_t charWidth) const -> Pixel
{
  ...
  return IColorMap::GetColorMix(outlineFontColor, charColor, fontTs.fontCharColorMixT);
}
