    ...
    -> ColorMatchedSetsMap
{
  ...
  return ColorMatchedSetsMap{{{
      {RED_GREEN_STD_MAPS,      GetTwoGroupsColorMatchedSet(Groups::RED_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::GREEN_STANDARD_MAPS)},
      {RED_BLUE_STD_MAPS,       GetTwoGroupsColorMatchedSet(Groups::RED_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::BLUE_STANDARD_MAPS)},
      {YELLOW_BLUE_STD_MAPS,    GetTwoGroupsColorMatchedSet(Groups::YELLOW_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::BLUE_STANDARD_MAPS)},
      {YELLOW_PURPLE_STD_MAPS,  GetTwoGroupsColorMatchedSet(Groups::YELLOW_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::PURPLE_STANDARD_MAPS)},
      {ORANGE_GREEN_STD_MAPS,   GetTwoGroupsColorMatchedSet(Groups::ORANGE_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::GREEN_STANDARD_MAPS)},
      {ORANGE_PURPLE_STD_MAPS,  GetTwoGroupsColorMatchedSet(Groups::ORANGE_STANDARD_MAPS,
                                                            goomRand,
                                                            Groups::PURPLE_STANDARD_MAPS)},
      {ALL_ONLY_STD_MAPS,       GetOneGroupColorMatchedSet(Groups::ALL_STANDARD_MAPS)},
      {HEAT_ONLY_STD_MAPS,      GetOneGroupColorMatchedSet(Groups::HEAT_STANDARD_MAPS)},
      {COLD_ONLY_STD_MAPS,      GetOneGroupColorMatchedSet(Groups::COLD_STANDARD_MAPS)},
      {DIVERGING_ONLY_STD_MAPS, GetOneGroupColorMatchedSet(Groups::SLIGHTLY_DIVERGING_SLIM_MAPS)},
      {DIVERGING_BLACK_ONLY_STD_MAPS,
                                GetOneGroupColorMatchedSet(Groups::DIVERGING_BLACK_STANDARD_MAPS)},
      {WES_ANDERSON_ONLY_MAPS,  GetOneGroupColorMatchedSet(Groups::WES_ANDERSON_MAPS)},
      {PASTEL_ONLY_MAPS,        GetOneGroupColorMatchedSet(Groups::PASTEL_STANDARD_MAPS)},
