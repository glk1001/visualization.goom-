...
public:
  ...
  void DrawDot(const Point2dInt& pos,
               uint32_t diameter,
...
{
  static constexpr float MAIN_COLOR_BRIGHTNESS = 15.0F;
                                       ...
                                       const Pixel& lowColor)
{
  ...
  { return GetDotMixedColor(x, y, diameter, bgnd, mainColor, m_bgndMainColorMixT); };
