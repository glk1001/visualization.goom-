...
auto LSystemFx::LSystemFxImpl::GetLSystemFileList() noexcept -> std::vector<LSystem::LSystemFile>
{
  ...
  auto
      lSysFileList =
          std::vector{
              LSystem::LSystemFile{        .filename = "bourke_bush",
                                   .overrides =
                                   {
                                   .minNumLSysCopies        = 2U,
                                   .maxNumLSysCopies        = 5U,
              ...
              LSystem::LSystemFile{.filename = "bourke_pentaplexity",
                                   .overrides =
                                   {
                                   .minNumLSysCopies        = 1U,
                                   .maxNumLSysCopies        = 5U,
              ...
              LSystem::LSystemFile{       .filename = "honda_tree_b",
                                   .overrides =
                                   {
                                   .minNumLSysCopies        = 2U,
                                   .maxNumLSysCopies        = 5U,
                                   ...
                                   .namedArgs =
                                   {
                                   {.name = "r2", .min = 0.7F, .max = 0.9F},
                                   {.name = "a0", .min = 30.0F, .max = 30.01F},
                                   {.name = "a2", .min = 30.0F, .max = 30.01F},
                                   {.name = "d", .min = 137.5F, .max = 137.51F},
                                   },
                                   }},
              LSystem::LSystemFile{     .filename = "ternary_tree_a",
                                   .overrides =
                                   {
                                   .minNumLSysCopies        = 2U,
                                   .maxNumLSysCopies        = 5U,
