...
public:
  ...
  void Inc(NormalizedCoords& normalizedCoords) const;
  void IncX(NormalizedCoords& normalizedCoords) const;
  void IncY(NormalizedCoords& normalizedCoords) const;
...
inline void NormalizedCoordsConverter::Inc(NormalizedCoords& normalizedCoords) const
{
  IncX(normalizedCoords);
  IncY(normalizedCoords);
}

inline void NormalizedCoordsConverter::IncX(NormalizedCoords& normalizedCoords) const
{
  normalizedCoords.m_fltCoords.x += m_ratioScreenToNormalizedCoord;
}

inline void NormalizedCoordsConverter::IncY(NormalizedCoords& normalizedCoords) const
{
