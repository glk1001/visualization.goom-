#ifndef VISUALIZATION_GOOM_LIB_GOOM_FILTERS_CRYSTAL_BALL_H
#define VISUALIZATION_GOOM_LIB_GOOM_FILTERS_CRYSTAL_BALL_H
...
#endif //VISUALIZATION_GOOM_LIB_GOOM_FILTERS_CRYSTAL_BALL_H
