#ifndef VISUALIZATION_GOOM_FILTER_IMAGE_SPEED_COEFFS_H
#define VISUALIZATION_GOOM_FILTER_IMAGE_SPEED_COEFFS_H
...
#endif //VISUALIZATION_GOOM_FILTER_IMAGE_SPEED_COEFFS_H
