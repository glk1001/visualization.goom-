#ifndef VISUALIZATION_GOOM_LIB_FILTERS_FILTER_COLORS_SERVICE_H
#define VISUALIZATION_GOOM_LIB_FILTERS_FILTER_COLORS_SERVICE_H
...
#endif //VISUALIZATION_GOOM_LIB_FILTERS_FILTER_COLORS_SERVICE_H
