...
auto GlslProgram::FindUniformLocations() -> void
{
  ...
  for (GLint i = 0; i < numUniforms; ++i)
  {
    ...
    //std::println("Uniform {}, name = {}, value = {}", i, name.data(), results[2]);
  }
#endif
}
