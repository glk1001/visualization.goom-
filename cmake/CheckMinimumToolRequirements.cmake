...
if (CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
        set(MIN_COMPILER_VERSION 12)
    endif ()
elseif (CMAKE_CXX_COMPILER_ID MATCHES ".*GNU")
    set(MIN_COMPILER_VERSION 11)
...
set(MIN_CPP_STANDARD 17)
if (CPP_STANDARD VERSION_LESS ${MIN_CPP_STANDARD})
    message(FATAL_ERROR "CPP_STANDARD = '${CPP_STANDARD}'. Minimum acceptable standard is '${MIN_CPP_STANDARD}'.")
endif ()
