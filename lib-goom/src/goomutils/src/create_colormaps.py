...
GENERATED_CODE_WARNING = f"// IMPORTANT - THIS CODE IS GENERATED BY '{__file__}' - DO NOT EDIT"
...
FINAL_PALETTABLE_INCLUDE_RELDIR = FINAL_INCLUDE_RELDIR + '/' + PALETTABLE_SUBDIR
    ...
    with open(f'{SRCE_DIR}/{ALL_MAPS_CPP}', 'w') as f:
        ...
        for m in used_mps:
            f.write(f'  {{{MAPS_ENUM_NAME}::{get_upper_cpp_name(m)},'
                    f' &{COLORDATA_NAMESPACE}::{get_upper_cpp_name(m)}}},'
                    + get_enum_line_end(m, dupl))
        f.write(f'}}}};\n')
        f.write('\n')
